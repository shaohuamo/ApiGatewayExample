...
#pragma warning disable 1591
        ...
        public static class Counters
        {
            ...
            public const string UserRegister = "tokenservice.user_register";
        }
...
#pragma warning restore 1591
        ...
        private static Counter<long> UserRegisterCounter = Meter.CreateCounter<long>(Counters.UserRegister);

        /// <summary>
        /// Helper method to increase <see cref="Counters.UserRegister"/> counter.
        /// </summary>
        /// <param name="clientId">Client Id, if available</param>
        public static void UserRegister(string? clientId)
            => UserRegisterCounter.Add(1, tag: new(Tags.Client, clientId));

        /// <summary>
        /// Helper method to increase <see cref="Counters.UserRegister"/> counter on failure.
        /// </summary>
        /// <param name="clientId">Client Id, if available</param>
        /// <param name="error">Error message</param>
        public static void UserRegisterFailure(string? clientId, string error)
            => UserRegisterCounter.Add(1, new(Tags.Client, clientId), new(Tags.Error, error));
    }
}
